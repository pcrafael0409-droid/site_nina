...
export default async function ClubeNinaPage() {
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="solid-card rounded-3xl p-8 relative overflow-hidden border border-nina-red-400/20 shadow-md">
        <div className="absolute top-0 right-0 w-64 h-64 bg-nina-red-400/10 rounded-full blur-3xl -z-10 translate-x-1/2 -translate-y-1/2 pointer-events-none"></div>
        <div className="absolute bottom-0 left-0 w-64 h-64 bg-nina-red-400/10 rounded-full blur-3xl -z-10 -translate-x-1/2 translate-y-1/2 pointer-events-none"></div>
        ...
        <div className="relative z-10 flex flex-col items-center">
          ...
          <div className="w-full bg-[#e8e3d5] rounded-full h-4 overflow-hidden mb-4 relative">
            <div 
              className="bg-nina-red-400 h-full rounded-full transition-all duration-1000 ease-out relative" 
